...
public class UiAutomatorHelper {
    ...
    private static void getUiHierarchyFile(IDevice device, File dst,
        ...
        try {
            device.executeShellCommand(command, new CollectingOutputReceiver(commandCompleteLatch), XML_CAPTURE_TIMEOUT_SEC * 1000);
    ...
    public static UiAutomatorResult takeSnapshot2(IDevice device, IProgressMonitor monitor,
                                                  boolean compressed) throws UiAutomatorException {
