...
import com.android.uiautomator.actions.NullAction;
...
public class UiAutomatorViewer extends ApplicationWindow {
    ...
    protected Control createContents(Composite parent) {
        ...
        //toolBarManager.add(new NullAction());
    ...
    protected void configureShell(Shell newShell) {
        ...
        newShell.setText("UI Automator Viewer (by Elio)");
    }

    @Override
    protected Point getInitialSize() {
        Rectangle area = Display.getDefault().getClientArea();
        return new Point(area.width / 3, area.height / 2);
    }
    ...
    protected Point getInitialLocation(Point initialSize) {
        ...
        return new Point((area.width - size.x) / 2, (area.height - size.y) / 2);
    }
